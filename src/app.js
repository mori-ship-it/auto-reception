...
var staffList=[{id:1,name:'田中 美咲',nameEn:'Misaki Tanaka',role:'スタイリスト',on:true,slackId:'',photo:''},{id:2,name:'鈴木 健太',nameEn:'Kenta Suzuki',role:'スタイリスト',on:true,slackId:'',photo:''},{id:3,name:'山本 さくら',nameEn:'Sakura Yamamoto',role:'スタイリスト',on:false,slackId:'',photo:''},{id:4,name:'佐藤 りな',nameEn:'Rina Sato',role:'アシスタント',on:true,slackId:'',photo:''}];
var nextStaffId=5;
